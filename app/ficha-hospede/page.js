...
<style>
  ...
  * { box-sizing: border-box; }
  html, body { width: 100%; }
  body {
    font-family: Arial, Helvetica, sans-serif; color: #1a1a1a; font-size: 11.5px; line-height: 1.45;
    margin: 0; padding: 0; max-width: 178mm; /* largura útil de uma A4 (210mm - margens) */
  }
  h1.hotel { font-size: 17px; text-align: center; margin: 0 0 14px; }
  .campos { display: grid; grid-template-columns: 1fr 1fr; gap: 8px 24px; margin-bottom: 16px; }
  ...
  .secao { margin-bottom: 9px; }
  .secao h3 { font-size: 11px; margin: 0 0 4px; }
  .secao p { margin: 0 0 3px; font-size: 9.5px; text-align: justify; }
  /* Assinatura fica sempre no FINAL do documento, depois de todo o texto */
  .assinatura { margin-top: 22px; }
